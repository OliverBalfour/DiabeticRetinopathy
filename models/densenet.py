...
from tensorflow.keras.applications.densenet import preprocess_input, DenseNet121 as DenseNet

batch_size = 10
num_epochs = 15
train_dir = 'data/proc/aug/224/'
model_name = 'models/h5/densenet121-headless.h5'

image_size = 224
image_shape = (image_size,image_size,3)

model = Sequential([
	DenseNet(weights='imagenet', include_top=False, input_shape=image_shape),
